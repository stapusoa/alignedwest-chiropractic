...
export const buttonScrolled = "bg-white/20 hover:bg-white/30";
export const buttonTransparent = "bg-white/10 hover:bg-white/20";

// Additional classes for layout adjustments
export const buttonFull = "hidden lg:flex";
export const buttonLearnMore = "hidden md:flex lg:hidden";
export const buttonIconOnly = "flex md:hidden";
export const ctaAndMenuContainer = "flex space-x-4 items-center";
