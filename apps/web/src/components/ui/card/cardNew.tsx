    ...
    >
      ...
      >
        ...
        {tag?.length > 0 && (
          <CardFooter>
            {tag.slice(0, 3).map((t) => (
              <Badge key={t} color="neutral" className="text-xs">
                {t}
              </Badge>
            ))}
            {tag.length > 3 && (
              <Badge color="neutral" className="text-xs">
                +{tag.length - 3} more
              </Badge>
            )}
          </CardFooter>
      ...
      {imageIsInline && badge && (
        <Badge color="default" className="absolute shadow-md z-100 top-2 left-2 capitalize">
          {badge}
        </Badge>
      )}
